/**
 * Turkish Provinces (81 İl)
 * Organized by region with codes and metadata
 * Source: Turkish Statistical Institute (TÜİK)
 */

export const TURKEY_PROVINCES = [
  { code: "01", name: "Adana", region: "Akdeniz" },
  { code: "02", name: "Adıyaman", region: "Güneydoğu" },
  ...
  { code: "21", name: "Diyarbakır", region: "Güneydoğu" },
  ...
  { code: "27", name: "Gaziantep", region: "Güneydoğu" },
  ...
  { code: "47", name: "Mardin", region: "Güneydoğu" },
  ...
  { code: "56", name: "Siirt", region: "Güneydoğu" },
  ...
  { code: "63", name: "Şanlıurfa", region: "Güneydoğu" },
  ...
  { code: "72", name: "Batman", region: "Güneydoğu" },
  { code: "73", name: "Şırnak", region: "Güneydoğu" },
  ...
  { code: "79", name: "Kilis", region: "Güneydoğu" },
...
export function getRegions() {
  const regions = new Set(
    TURKEY_PROVINCES.map((p) => p.region)
  );
