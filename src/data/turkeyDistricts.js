/**
 * Turkish Districts (ilçeler) — 81 İl / 973+ İlçe
 * Source: İçişleri Bakanlığı İller İdaresi Genel Müdürlüğü resmi ilçe listeleri
 *
...
export const TURKEY_DISTRICTS = [
  ...
  { code: "53", name: "Rize", d: ["Ardeşen", "Çamlıhemşin", "Çayeli", "Derepazarı", "Fındıklı", "Güneysu", "Hemşin", "İkizdere", "İyidere", "Kalkandere", "Merkez", "Pazar"] },
   ...
   // 59 - Tekirdağ
   { code: "59", name: "Tekirdağ", d: ["Çerkezköy", "Çorlu", "Hayrabolu", "Kapaklı", "Malkara", "Merkez", "Muratlı", "Saray", "Süleymanpaşa", "Şarköy"] },
   // 60 - Tokat
   { code: "60", name: "Tokat", d: ["Almus", "Artova", "Başçiftlik", "Erbaa", "Merkez", "Niksar", "Pazar", "Reşadiye", "Sulusaray", "Turhal", "Yeşilyurt", "Zile"] },
   // 61 - Trabzon
   { code: "61", name: "Trabzon", d: ["Akçaabat", "Araklı", "Arsin", "Beşikdüzü", "Çaykara", "Dernekpazarı", "Düzköy", "Hayrat", "Köprübaşı", "Maçka", "Of", "Ortahisar", "Sürmene", "Şalpazarı", "Tonya", "Vakfıkebir", "Yomra"] },
   // 62 - Tunceli
   ...
   // 64 - Uşak
   { code: "64", name: "Uşak", d: ["Banaz", "Eşme", "Karahanlı", "Merkez", "Sivaslı", "Ulubey"] },
   // 65 - Van
   { code: "65", name: "Van", d: ["Bahçesaray", "Başkale", "Çaldıran", "Çatak", "Edremit", "Erciş", "Gevaş", "Gürpınar", "İpekyolu", "Muradiye", "Özalp", "Saray", "Tuşba"] },
   // 66 - Yozgat
   { code: "66", name: "Yozgat", d: ["Akdağmadeni", "Aydıncık", "Boğazlıyan", "Çandır", "Çayıralan", "Çekerek", "Kadışehri", "Merkez", "Sarıkaya", "Sorgun", "Şefaatli", "Yenifakılı", "Yerköy"] },
   // 67 - Zonguldak
   { code: "67", name: "Zonguldak", d: ["Alaplı", "Çaycuma", "Devrek", "Ereğli", "Gökçebey", "Kilimli", "Kozlu", "Merkez"] },
   // 68 - Aksaray
   { code: "68", name: "Aksaray", d: ["Ağaçören", "Eskil", "Güzelyurt", "Merkez", "Ortaköy", "Sarıyahşi"] },
   // 69 - Bayburt
   { code: "69", name: "Bayburt", d: ["Aydıntepe", "Demirözü", "Merkez"] },
   // 70 - Karaman
   { code: "70", name: "Karaman", d: ["Ayrancı", "Başyayla", "Kazımkarabekir", "Merkez", "Sarıveliler"] },
   // 71 - Kırıkkale
   { code: "71", name: "Kırıkkale", d: ["Bahşili", "Balışeyh", "Çelebi", "Delice", "Karakeçili", "Keskin", "Merkez", "Sulakyurt", "Yahşihan"] },
   // 72 - Batman
   ...
   // 75 - Ardahan
   { code: "75", name: "Ardahan", d: ["Çıldır", "Göle", "Hanak", "Merkez", "Posof"] },
   // 76 - Iğdır
   { code: "76", name: "Iğdır", d: ["Aralık", "Karakoçan", "Merkez", "Tuzluca"] },
   // 77 - Yalova
   { code: "77", name: "Yalova", d: ["Altınova", "Armutlu", "Çiftlikköy", "Merkez", "Termal"] },
   // 78 - Karabük
   ...
   // 81 - Düzce
   { code: "81", name: "Düzce", d: ["Akçakoca", "Cumayeri", "Çilimli", "Düzce", "Gölyaka", "Gümüşova", "Kaynaşlı", "Merkez", "Yığılca"] },
];
