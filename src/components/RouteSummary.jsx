...
export default function RouteSummary({
  ...
  return (
    <div className="space-y-4">
      ...
      {fuelCostInfo && (
        <div className="rounded-2xl border border-[#00E5A0]/20 bg-[#00E5A0]/[0.03] p-4 sm:p-5 transition-all">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-[#00E5A0]/30 bg-[#00E5A0]/10 text-[#00E5A0]">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-black uppercase tracking-[0.14em] text-[#00E5A0]">
            ...
            <div className="flex items-center justify-between sm:justify-end gap-3 border-t border-white/5 pt-2 sm:border-t-0 sm:pt-0">
              <div className="text-right">
                <div className="text-base sm:text-lg font-black tracking-tight text-[#00E5A0]">
          ...
          {showFormulaDetails && (
            <div className="mt-3 rounded-xl border border-white/6 bg-black/40 p-3.5 text-xs text-slate-300 space-y-1.5 animate-fadeIn">
              ...
              <div className="font-mono text-[11px] text-[#00E5A0]/90">
