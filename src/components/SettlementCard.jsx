...
export default function SettlementCard({
  ...
  const getStatusBadge = () => {
    switch (status) {
      case "approved":
        return { label: "✓ MUTABAKAT ONAYLANDI", color: "border-[#00E5A0]/40 bg-[#00E5A0]/10 text-[#00E5A0]" };
      case "paid":
        return { label: "✓ ÖDEME TAMAMLANDI", color: "border-[#00E5A0]/40 bg-[#00E5A0]/15 text-[#00E5A0]" };
      case "ready":
        return { label: "⚡ ONAYA HAZIR", color: "border-[#00E5A0]/30 bg-[#00E5A0]/10 text-[#00E5A0]" };
      case "pending_pod":
        ...
        {!isShipper && (
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
              ...
              {/* 4. Gerçekleşen Kâr */}
              <div className="rounded-2xl border border-[#00E5A0]/30 bg-[#00E5A0]/[0.06] p-4 text-center">
                <div className="text-[10px] font-bold uppercase tracking-[0.14em] text-[#00E5A0]">Gerçekleşen Kâr</div>
                <div className="mt-1 text-lg sm:text-xl font-black text-[#00E5A0]">
                  {formatCurrencyTR(profitActual)}
                </div>
                <div className="mt-0.5 text-[10px] text-[#00E5A0]/80">Net Sefer Kârı</div>
              </div>

              {/* 5. Gerçekleşen Marj */}
              <div className="rounded-2xl border border-[#00E5A0]/30 bg-[#00E5A0]/[0.06] p-4 text-center col-span-2 sm:col-span-1">
                <div className="text-[10px] font-bold uppercase tracking-[0.14em] text-[#00E5A0]">Gerçekleşen Marj</div>
                <div className="mt-1 text-lg sm:text-xl font-black text-[#00E5A0]">
                  %{marginActual.toLocaleString("tr-TR", { minimumFractionDigits: 1, maximumFractionDigits: 1 })}
                </div>
                <div className="mt-0.5 text-[10px] text-[#00E5A0]/80">Kârlılık Oranı</div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-[#101923] p-4 sm:p-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div className="rounded-xl border border-white/[0.04] bg-[#060B11] p-3 text-center">
                  ...
                  <div className="mt-1 text-base font-black text-[#00E5A0]">
                ...
                <div className="rounded-xl border border-white/[0.04] bg-[#060B11] p-3 text-center">
                  ...
                  <div className={`mt-1 text-base font-black ${
                    costVariance <= 0 ? "text-[#00E5A0]" : "text-[#FF5C5C]"
                  }`}>
        ...
        {isShipper && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
            <div className="rounded-2xl border border-white/[0.06] bg-[#101923] p-5">
              ...
              <div className="text-2xl font-black text-[#00E5A0] mt-1.5">
        ...
        {isShipper && status !== "approved" && status !== "paid" && status !== "disputed" && (
          <div className="pt-2 flex flex-wrap gap-3">
            <button
              ...
              className="flex-1 rounded-xl bg-[#00E5A0] px-6 py-3.5 text-xs font-black text-[#060B11] shadow-[0_0_24px_rgba(0,229,160,0.25)] hover:bg-[#00c78a] disabled:opacity-40 disabled:pointer-events-none transition duration-150 active:scale-[0.99]"
            >
              ✓ Mutabakatı Onayla
            </button>
